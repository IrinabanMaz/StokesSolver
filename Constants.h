...
struct QuadConstants
{
    ...
    QuadConstants(const size_t& ntrap = 8, const size_t& ngl = 8)
    {
        NUMTRAPNODES = ntrap;
        NUMGLNODES = ngl;
    ...
    QuadConstants& operator =(const QuadConstants& consts)
    {
    ...
    QuadConstants(const QuadConstants& consts)
    {
        NUMGLNODES = consts.NUMGLNODES;
        NUMTRAPNODES = consts.NUMTRAPNODES;
        GLweights = consts.GLweights;
